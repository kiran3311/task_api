...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.addColumn('TASKS', 'REMARKFOREDITTING_TEMP', {
    ...
    await queryInterface.removeColumn('TASKS', 'REMARKFOREDITTING');

    // 4. Rename the new CLOB column to match the original name
    await queryInterface.renameColumn('TASKS', 'REMARKFOREDITTING_TEMP', 'REMARKFOREDITTING');
  },

...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.sequelize.query(`
      UPDATE TASKSHISTORY 
      SET REMARKFOREDITTING_TEMP = "REMARKFORINNERHTML"
    `);

    // 3. Drop old VARCHAR2 column
    await queryInterface.removeColumn('TASKSHISTORY', 'REMARKFORINNERHTML');

    // 4. Rename the new CLOB column to match the original name
    await queryInterface.renameColumn('TASKSHISTORY', 'REMARKFOREDITTING_TEMP', 'REMARKFORINNERHTML');
  },
